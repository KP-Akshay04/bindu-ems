...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      /*
       * GPS verification is required for EVERY role.
       *
       * Super Admin, HR and Employee are all employees
       ...
       *
       * GPS coordinates are also passed to the
       * authentication endpoint so the backend can
       * perform its location validation.
       */
      ...
      /*
       * Every authenticated employee must have
      ...
      if (
        ...
        try {
          ...
          /*
           * Authentication succeeded but attendance
           * recording failed.
           *
           * Do not allow the user to enter the
           * dashboard without attendance validation.
           */
          logout();
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="leading-none">
              <div className="flex items-baseline gap-2">
                ...
                <span className="text-2xl sm:text-3xl font-extrabold tracking-tight text-brand-500">
                  EMS
                </span>
              </div>
