 ...
 const load = async () => {
  ...
  try {
    ...
    if (isEmployee) {
      // ---------------------------------------------------
      // EMPLOYEE DASHBOARD
      // Only request the logged-in employee's own data.
      // ---------------------------------------------------
    ...
    setAttendance(
      extractList(attendanceData, "attendance")
    );
    ...
    setLeaves(
      extractList(leavesData, "leaves")
    );

    setPayroll(
      extractList(payrollData, "payroll")
    );

    const annList = extractList(
      announcementsData,
      "announcements"
    );
